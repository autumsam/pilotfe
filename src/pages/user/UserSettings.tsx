...
import { User, Lock, Bell, Loader2, Settings } from "lucide-react";
    ...
    <div className="min-h-screen bg-background pb-20 md:pb-6">
      ...
      <div className="px-4 md:px-6 space-y-4 md:space-y-6">
        ...
        <div className="hidden md:grid md:grid-cols-2 gap-6">
          ...
          <Card className="md:col-span-2 border-l-4 border-l-green-500 shadow-sm hover:shadow-md transition-shadow">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
